...
**JYelp** is a Yelp search app using the [Yelp API](http://www.yelp.com/developers/documentation/v2/search_api).
...
1. The search navigation bar
2. Actual Color for the app

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://imgur.com/3b2e46e2-ee01-44c8-87a4-5b4c65f7f84b.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
